...
public class PortalTypePage implements Page<JsonNode> {
  ...
  public PortalTypePage withRuntime(BigDecimal runtime) {
    this.runtime = runtime;
    return this;
  }
  ...
  public PortalTypePage withCount(Integer count) {
    this.count = count;
    return this;
  }
  ...
  public PortalTypePage withItems(List<JsonNode> items) {
    this.items = items;
    return this;
  }
  ...
  public PortalTypePage withNext(String next) {
    this.next = next;
    return this;
  }
  ...
  public PortalTypePage withPage(Integer page) {
    this.page = page;
    return this;
  }
  ...
  public PortalTypePage withPages(Integer pages) {
    this.pages = pages;
    return this;
  }
  ...
  public PortalTypePage withPagesize(Integer pagesize) {
    this.pagesize = pagesize;
    return this;
  }
  ...
  public PortalTypePage withPrevious(String previous) {
    this.previous = previous;
    return this;
  }
  ...
  public PortalTypePage withUrl(String url) {
    this.url = url;
    return this;
  }
  ...
  public boolean equals(Object rhs) {
    ...
    if (!(rhs instanceof PortalTypePage o)) return false;
